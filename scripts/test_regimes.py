...
def main() -> int:
  ...
  assert standardForMonth("1949-04") == MonetaryStandard.YEN_USD_PEG
  assert standardForMonth("1971-12") == MonetaryStandard.SMITHSONIAN_PEG
  assert standardForMonth("1973-02") == MonetaryStandard.YEN_FLOAT
  assert standardForMonth("2026-08") == MonetaryStandard.YEN_FLOAT
  ...
  assert economy2.monetaryStandard == MonetaryStandard.YEN_USD_PEG
